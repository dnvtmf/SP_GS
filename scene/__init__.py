...
# from scene.deform_model_2 import DeformModel
# from scene.deform_model_3 import DeformModel
from scene.fine_deform_model import NonRigidDeformationModel
...
class Scene:
    ...
    def __init__(
        self, args: ModelParams, gaussians: GaussianModel, load_iteration=None, ply_path=None, shuffle=True,
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):
            ...
            if os.path.exists(os.path.join(args.source_path, "points3D_downsample.ply")):
                print("Found dataset.json & points3D_downsample.ply file, assuming hyper data set!")
                scene_info = sceneLoadTypeCallbacks["hyper"](args.source_path, args.eval)
            else:
