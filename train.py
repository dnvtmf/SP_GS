...
def training(
    ...
    for iteration in range(1, opt.iterations + 1):
        ...
        if iteration < opt.warm_up:
            ...
            (d_xyz, d_rotation, d_scaling), loss_aux = deform.step(
                gaussians.get_xyz.detach(), time_input + t_noise, use_mlp=True)
        ...
        if isinstance(d_xyz, torch.Tensor):
            ...
            lambda_re = getattr(opt, 'lambda_re', 0.)
            loss = loss + losses['re_xyz'] * 1e-3  # lambda_re
